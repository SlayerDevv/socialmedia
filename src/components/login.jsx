    ...
    return (
        <div className="w-[450px] p-5 h-[450px] rounded-2xl bg-white bg-opacity-20 shadow-lg shadow-black/10 backdrop-blur-sm border border-white/30">
            ...
            <div className="space-y-[28px] mt-[45px] ">
                ...
                <input type="email" onChange={(e) => setEmail(e.target.value)} id="email" name="email" required className="flex mt-1 rounded-2xl p-[5px] pr-[200px] bg-[#F5F5F5] shadow-[0px_0px_50px_1px_#FFF] outline-none" />
                </div>
                <div>
                <label htmlFor="password" className="ml-1 text-sm">Password</label>
                <input type="password" onChange={(e) => setPassword(e.target.value)} id="password" name="password" required className="flex mt-1 rounded-2xl p-[5px] pr-[200px] bg-[#F5F5F5] shadow-[0px_0px_50px_1px_#FFF] outline-none" />
                </div>
                <div className="flex items-center justify-between">
                    ...
                    <button type='button' onClick={() => login(email, password)} disabled={loading} className="flex bg-[#F5F5F5] shadow-[0px_0px_50px_1px_#FFF] hover:bg-[#F5F5F5]/80 duration-500 py-2 px-5 text-black font-medium justify-center items-center rounded-3xl">Login</button>
                </div>
